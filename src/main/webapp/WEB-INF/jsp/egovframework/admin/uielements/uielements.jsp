							...
							<div class="widget-content">
							  <div class="padd">
								...
								<div class="make-switch">
								 ...
								 <div class="make-switch">
									 <input type="checkbox" data-on="info" data-off="success" checked>
								 </div>
								  
								 <div class="make-switch">
									 <input type="checkbox" data-on="success" data-off="warning" checked>
								 </div>
								  
								 <div class="make-switch">
									 <input type="checkbox" data-on="warning" data-off="danger" checked>
								 </div>
								  
								 <div class="make-switch">
									 <input type="checkbox" data-on="danger" data-off="default" checked>
								 </div>
								  
								 <div class="make-switch">
									 <input type="checkbox" data-on="default" data-off="primary" checked>
								 </div> 
								<hr />                                  
							   ...
							   <div class="progress progress-striped active">
								...
								<h5>Datepicker</h5>
								  <div id="datetimepicker1" class="input-append">
									<input data-format="yyyy-MM-dd" class="picker" type="text">
									<span class="add-on">
								...
								<h5>Timepicker</h5>
								  <div id="datetimepicker2" class="input-append">
									<input data-format="hh:mm:ss" class="picker" type="text">
									<span class="add-on">
