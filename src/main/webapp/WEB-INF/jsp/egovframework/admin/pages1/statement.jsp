...
<div class="mainbar">
				...
				<div class="page-head">
					...
					<div class="bread-crumb pull-right">
						...
						<a href="#" class="bread-current">Statement</a>
					</div>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="well bviolet">
														<h2>$848</h2>
														<p>Current Period Earnings (23/23/2012)</p>
													</div>
												</div>
												<div class="col-md-4">
													<div class="well blightblue">
														<h2>$883</h2>
														<p>Previous Month Earning (34/23/2032)</p>                        
													</div>
												</div>
												<div class="col-md-4">
													<div class="well bgreen">
														<h2>$23232</h2>
														<p>All Time Earning (23/23/2023 - 23/43/2021)</p>
													</div>
												</div>
											</div>
											<div class="row">
