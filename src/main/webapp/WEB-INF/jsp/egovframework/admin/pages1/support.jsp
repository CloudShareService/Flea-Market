...
<div class="mainbar">
				...
				<div class="page-head">
					...
					<div class="bread-crumb pull-right">
						...
						<a href="#" class="bread-current">Support</a>
					</div>
									...
									<div class="widget-content">
										...
										<div class="padd">
											...
											<div class="support-contact">
												...
												<hr />
												<i class="fa fa-phone"></i> Phone<strong>:</strong> 123-456-7890
												<hr />
												<i class="fa fa-envelope-o"></i> Email<strong>:</strong> something@gmail.com
												<hr />
												<i class="fa fa-home"></i> Address<strong>:</strong> 12, Srtington Street, NY, USA 
												<hr />
												<!-- Button -->
