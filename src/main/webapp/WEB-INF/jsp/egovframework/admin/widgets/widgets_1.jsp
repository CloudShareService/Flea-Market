...
<div class="mainbar">
				...
				<div class="bread-crumb pull-right">
				  ...
				  <a href="#" class="bread-current">Widgets</a>
				</div>
				  ...
				  <div class="row">
					  ...
					  <div class="widget wlightblue">
						...
						<div class="widget-content">
						  ...
						  <ul class="activity">
							...
							<li>
							  <!-- Icon with avtivity  -->
							  <i class="fa fa-envelope-o red"></i> <strong>Ashok</strong> Mailed you on 3/12/2032
							</li>

							<li>
							  <i class="fa fa-share violet"></i> <strong>Go to america</strong> Shared by <strong>Ravi Kumar</strong>
							</li>

							<li>
							  <i class="fa fa-sign-in green"></i> <strong>Admin</strong> Signed in on 2/4/2012
							</li>

							<li>
							  <i class="fa fa-money lightblue"></i> <strong>Babu Kumar</strong> made $5000 today.
							</li>
							   
							<li>
							  <i class="fa fa-upload blue"></i> <strong>Font Asesome Mp3</strong> got uploaded by <strong>Admin</strong>.
							</li>

							<li>
							  <i class="fa fa-user ornage"></i> <strong>Kumarasamy</strong> joined the site on 3/5/2012.
							</li>

							<li>
							  <i class="fa fa-bookmark green"></i> You Bootmarked the site <strong>Google</strong>.
							</li> 

							<li>
							  <i class="fa fa-plus red"></i> <strong>Admin</strong> added the article <strong>Why not now?</strong>.
							</li> 
						  ...
						  <div class="widget-foot">
							<button class="btn pull-right btn-xs btn-danger">Clear All</button>
							<div class="clearfix"></div>
						  </div>
					  </div>
					</div>
					...
					<div class="col-md-4">
					  <div class="widget wblue">
						<div class="widget-head">
						  <div class="pull-left">Google Map</div>
						  <div class="widget-icons pull-right">
							<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
							<a href="#" class="wclose"><i class="fa fa-times"></i></a>
						  </div>
				  ...
				  <div class="row">
						  ...
						  <div class="padd">
							...
							<div class="user">
							  ...
							  <div class="user-details">
								...
								<a href="#" class="btn btn-xs btn-success"><i class="fa fa-envelope-o"></i></a>
								<a href="#" class="btn btn-info btn-xs"><i class="fa fa-user"></i></a> 
							  </div>
							  <div class="clearfix"></div>
							</div>
					...
					<div class="col-md-7">
					  ...
					  <div class="widget wviolet">
						<div class="widget-head">
						  <div class="pull-left">Quick Setting</div>
						  <div class="widget-icons pull-right">
							<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a> 
							<a href="#" class="wclose"><i class="fa fa-times"></i></a>
						  </div>
